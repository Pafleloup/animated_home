...
private:
  ...
  static constexpr KDCoordinate k_sideMargin = 100;
  static constexpr KDCoordinate k_bottomMargin = 14;
  static constexpr KDCoordinate k_indicatorMargin = 10;

  #ifndef _FXCG
  static constexpr int k_numberOfColumns = 1;
  static constexpr int k_cellHeight = 30;
  static constexpr int k_cellWidth = 140;
  #else
  // A different screen resolution so different dimensions
  static constexpr int k_numberOfColumns = 1;
  static constexpr int k_cellHeight = 30;
  static constexpr int k_cellWidth = 180;
  #endif
