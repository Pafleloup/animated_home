...
private:
  static constexpr KDCoordinate k_iconMargin = 0;
  static constexpr KDCoordinate k_iconWidth = 0;
  static constexpr KDCoordinate k_iconHeight = 0;
  static constexpr KDCoordinate k_nameWidthMargin = 20;
  static constexpr KDCoordinate k_nameHeightMargin = 7;
  IconView m_iconView;
